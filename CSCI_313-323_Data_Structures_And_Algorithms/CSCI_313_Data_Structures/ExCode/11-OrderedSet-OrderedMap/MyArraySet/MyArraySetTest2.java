...
// Default ordering of persons is the increasing order wrt name
...
class MyArraySetTest2 {
	static void print(MyOrderedSet<Person> set){
	...
	static public void main(String argv[]){
		...
		MyOrderedSet<Person> persons = new MyArraySet<>();            // Default ordering
//		MyOrderedSet<Person> persons = new MyArraySet<>(comparator);  // Custom ordering
