...
/// each occurrence is considered a distinct element. Unlike fixed-size arrays, lists grow and shrink dynamically.
///
...
class ArrayListEx {
	static public void main(String argv[]){
		try {
			List<Integer> list = new ArrayList<>(5);  // 5 is the initial capacity
